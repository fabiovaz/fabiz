...
export default function Home() {
	return (
		<main className="container max-w-3xl px-4 md:px-0">
			<section id="home" className="mt-28 space-y-4">
				<Badge title="INÍCIO" icon="home" />
				<h1 className="pt-6 text-4xl md:text-6xl leading-normal md:leading-relaxed text-white">
					Diga olá para a <span className="text-meadow font-bold">Fabiz</span>. Criando experiências
					para o seu sucesso online
				</h1>
			...
			<section id="about" className="mt-28 space-y-4">
				<Badge title="SOBRE" icon="about" />
				<h1 className="pt-6 text-3xl md:text-5xl leading-normal md:leading-normal text-white">
			...
			<section id="services" className="mt-28 space-y-4">
        ...
        <div className="container">
          <div className="row">
            <div className="col">
              <Badge title="PORTFÓLIO" className="mt-10 mb-5" />
            </div>
          </div>
          <div className="row">
            <div className="col">
              <h1 className="display-5 lh-base"><span className="text-primary">Projetos</span> em destaque</h1>
            </div>
          </div>
        </div>
      </section> */}
        ...
        <div className="container">
          <div className="row">
            <div className="col">
              <Badge title="DEPOIMENTOS" className="mt-10 mb-5" />
            </div>
          </div>
          <div className="row">
            <div className="col">
              <h1 className="display-5 lh-base">Confiança dos <span className="text-primary">Clientes</span></h1>
            </div>
          </div>
        </div>
      </section> */}

			<section id="contact" className="mt-28 space-y-4">
          ...
          <div className="row">
            <div className="col-md-6 mb-5">
              ...
              <input type="text" className="form-control" id="name" placeholder="Seu nome completo" />
            </div>
            <div className="col-md-6 mb-5">
              <label htmlFor="email" className="form-label">EMAIL</label>
              <input type="email" className="form-control" id="email" placeholder="Seu endereço de email" />
            </div>
            <div className="col-md-6 mb-5">
              <label htmlFor="phone" className="form-label">TELEFONE (OPCIONAL)</label>
              <input type="text" className="form-control" id="phone" placeholder="Seu número de telefone" />
            </div>
            <div className="col-md-6 mb-5">
              <label htmlFor="subject" className="form-label">ASSUNTO</label>
              <input type="email" className="form-control" id="subject" placeholder="Digite o assunto" />
            </div>
            <div className="col-md-6 mb-5">
              <label htmlFor="mensagem" className="form-label">MENSAGEM</label>
              <textarea className="form-control" id="mensagem" rows={4} placeholder="Escreva aqui a sua mensagem..." />
            </div>
